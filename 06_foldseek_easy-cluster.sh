...
# Create directory
mkdir -p ./outputs/clustering_results

# Fold-seek cluster
foldseek easy-cluster ./pdbs/unique_genes/ unique_genes_cluster_result tmp -c 0.5 
foldseek easy-cluster ./pdbs/core_genes/ core_genes_cluster_result tmp -c 0.5

mv *cluster_result* ./outputs/clustering_results
