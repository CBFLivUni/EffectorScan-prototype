...
effector = setNames(c("#00A08A", "#F2AD00", "#F98400", "#5BBCD6"), c("Cytoplasmic", "Apoplastic", "Apoplastic/cytoplasmic", "Non-effector")),
confidence_score = setNames(c("#b52c17", "#e54b35", "#ed8778", "#f6c3bb"), c("High confidence", "Medium confidence", "Low confidence", "Very low confidence"))
