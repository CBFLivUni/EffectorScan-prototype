...
# Script to download local versions of various protein databases
# Structure data is stored in compressed 3Di format
foldseek databases databases/PDB pdb tmp
foldseek databases databases/Alphafold/Swiss-Prot swissprot tmp
foldseek databases databases/Alphafold/UniProt uniprot tmp 
foldseek databases databases/Alphafold/UniProt50 uniprot50 tmp 
